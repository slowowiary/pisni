  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .word.pre-active {
      color: #7a0000;
      text-shadow:
        0 6px 18px rgba(255, 200, 0, 0.40),
        0 10px 35px rgba(255, 200, 0, 0.20);
    }
    .word.active {
      color: #cc0000;
      text-shadow:
        0 6px 20px rgba(255, 200, 0, 0.70),
        0 10px 40px rgba(255, 200, 0, 0.40),
        0 16px 60px rgba(255, 200, 0, 0.20);
    }
